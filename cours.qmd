...
-   ✍️ **L'écriture** (créer, résumer) a vu sa part baisser de 36% à
    **24%**.
...
-   **SiEBERT** : Fine-tuning l'analyse de sentiment Modèle généraliste
    affiné sur **272 jeux de données** en anglais pour créer un
    classificateur robuste [@hartmannMoreFeelingAccuracy2023a].
:::
...
| **Perplexity Pro** | **20 \$/mois** | Recherche avancée, modèles premium, import de fichiers | [Site](https://www.perplexity.ai/enterprise/pricing) |
...
## Outils utiles pour la revue de littérature {style="font-size:0.6em"}

Bien sûr il existe les LLMs bien connus comme ChatGPT, Claude, Gemini,
Mistral, etc. mais certains autres outils spécialisés :

| Outil | Fonction principale | Cas d’usage typique | Lien |
|-------------|----------------------|-----------------------|-------------|
| **Perplexity.ai** | Moteur de recherche conversationnel (RAG) | Obtenir une vue d’ensemble rapide et sourcée sur un sujet | [perplexity.ai](https://www.perplexity.ai) |
...
| **Consensus** | Synthèse de résultats à partir d’articles scientifiques | Obtenir des réponses à des questions précises | [consensus.app](https://consensus.app) |
